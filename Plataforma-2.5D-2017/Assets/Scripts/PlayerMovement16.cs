...
public class PlayerMovement16 : MonoBehaviour
{
    ...
    [SerializeField] private Collider2D _wallColl;
        ...
        if (_isJumping)
        {
            ...
            else if (!_isFastFalling)
            {
                ...
                else
                {
                    ...
                    VerticalVelocity += MoveStats.Gravity * MoveStats.GravityOnReleaseMultiplier * Time.fixedDeltaTime * MoveStats.JumpWallFallMultiplier;
    ...
    private void IsGrounded()
    {
        ...
        if (_groundHit.collider != null)
        {
            ...
            MoveStats.NumberOfJumpsAllowed = 2;
        }
        else
        {
            _isGrounded = false;
    ...
    void BumpedHead()
    {
        ...
        // Detecta si hay colisión con la cabeza
        ...
        if (MoveStats.DebugShowHeadBumpBox)
        {
            ...
            // Dibujar los rayos para la detección de cabeza
    ...
    void WallCol()
    {
        Vector2 boxCastOrigin = new Vector2(_wallColl.bounds.center.x, _wallColl.bounds.min.y);
        Vector2 boxCastSize = new Vector2(_wallColl.bounds.size.x, MoveStats.GroundDetectionRayLength);

        RaycastHit2D wallHit = Physics2D.BoxCast(boxCastOrigin, boxCastSize, 0f, Vector2.right, MoveStats.HeadDetectionRayLength, MoveStats.GroundLayer);
        RaycastHit2D wallHit1 = Physics2D.BoxCast(boxCastOrigin, boxCastSize, 0f, Vector2.left, MoveStats.HeadDetectionRayLength, MoveStats.GroundLayer);


        if (wallHit.collider != null || wallHit1.collider != null)
        {
            _isWalled = true;
        }
        else
